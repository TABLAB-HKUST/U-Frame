...
if __name__ == '__main__':
    ...
    parser.add_argument('--overlap_size', type=int, default=8, help='overlapping size. 0< os <overlap_max')
    ...
    parser.add_argument('--tol', type=int, default=64, help='tolerance size')
